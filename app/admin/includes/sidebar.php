 ...
 * Shows navigation menu for admin panel
 */
...
<div class='sidebar' id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        <a href='/hms/app/admin/dashboard.php'>
            <span class="icon">📊</span> Dashboard
        </a>
        <a href='/hms/app/admin/reservation.php'>
            <span class="icon">📅</span> Reservations
        </a>
        <a href='/hms/app/admin/room.php'>
            <span class="icon">🏠</span> Manage Rooms
        </a>
        <a href='/hms/app/admin/users.php'>
            <span class="icon">👥</span> Staff
        </a>
        <a href='/hms/app/admin/reports.php'>
            <span class="icon">📋</span> Complaints
        </a>
        <a href='/hms/app/admin/reviews.php'>
            <span class="icon">⭐</span> Reviews
        </a>
        <a href='/hms/app/admin/manage_bookings.php'>
            <span class="icon">📖</span> Manage Bookings
        </a>
        <a href='/hms/app/admin/statistics.php'>

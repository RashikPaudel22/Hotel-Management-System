...
// LOAD ADMIN THEME HEADER
// This ensures we get the global styles
loadHeader('Customer - New Reservation');
...
<div class="main-content">
    ...
    <div class="header">
        ...
        <p style="color: var(--text-gray);">Fill in the details below to create a new reservation</p>
        <?php if ($is_logged_in): ?>
            <div class="user-info" style="margin-top: 10px; font-size: 13px; color: var(--text-light);">
...
<script>
    ...
    function loadRoomsForType(typeId) {
        ...
        // IMPORTANT: Path adjusted for admin/reservation.php location
